...
namespace Smuxi.Frontend.Gnome
{
    public class ChatViewManager : ChatViewManagerBase<ChatView>
    {
        ...
        {
            f_Notebook = notebook;
            f_Notebook.SwitchPage += (sender, e) => {
                ChatView to = f_Notebook.GetChat((int)e.PageNum);
                ChatView @from = ActiveChat;
                OnChatSwitched(new ChatViewManagerChatSwitchedEventArgs<ChatView>(@from, to));
            };
            f_TreeView = treeView;
